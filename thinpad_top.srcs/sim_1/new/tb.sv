...
//  文件名：tb.v
//  简要说明：此文件是上层模块thinpad_top的测试文件，在实际测试时，只需在BASE_RAM_INIT_FILE中填写指令(.bin)文件的绝对地址，
//           即可载入相应的指令文件，进行仿真测试
...
parameter BASE_RAM_INIT_FILE = "C:\\Users\\hp\\Desktop\\competition\\nscscc2021\\2021135\\thinpad_top.srcs\\sim_1\\new\\test"; //BaseRAM初始化文件，请修改为实际的绝对路径
